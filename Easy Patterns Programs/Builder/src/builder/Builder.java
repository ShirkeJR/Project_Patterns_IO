...
class ItaliaMealBuilder implements MealBuilder{
    private Meal m;
    public ItaliaMealBuilder(){this.m = new Meal();}
    @Override
    public void makeDrink() {  m.setDrink("red wine");}
    @Override
    public void makeMainCourse() { m.setMainCourse("pizza"); }
    @Override
    public Meal getMeal() {return m; }
}
class MealDirector {
    MealBuilder mb = null;
    public MealDirector(MealBuilder mb) {this.mb = mb; }
    public void ConstructMeal(){
        mb.makeDrink();
        mb.makeMainCourse();
    }
    public Meal getMeal(){  return mb.getMeal(); }
} 